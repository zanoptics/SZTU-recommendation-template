...
Center for Intense Laser Application Technology, \\
Shenzhen Technology University
}

%%%%%%%%%%%%  Additional Contact Information %%%%%%%%%%%
\def\Where{%
    \textbf{\color{SZTUblue}
    \href{https://cep.sztu.edu.cn/index.htm}{College of Engineering Physics}, \\
    Center for Intense Laser \\ Application Technology, \\
...
\def\CityZip{Shenzhen Guangdong, China, 518118}

\def\TEL{\textbf{\color{SZTUblue}Phone}: +86 0755 2325 6562}

\def\Email{\textbf{\color{SZTUblue}E-mail}: \href{mailto:name@sztu.edu.cn}{name@sztu.edu.cn}} % LOOK TODO path
